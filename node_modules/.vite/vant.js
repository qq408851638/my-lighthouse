...
var [name16, bem16] = createNamespace("field");
...
var Field_default = defineComponent({
  ...
  setup(props, _ref) {
    ...
    var renderInput = () => {
      var controlClass = bem16("control", [getProp("inputAlign"), {
    ...
    var renderWordLimit = () => {
      if (props.showWordLimit && props.maxlength) {
        ...
        return createVNode("div", {
          "class": bem16("word-limit")
        }, [createVNode("span", {
          "class": bem16("word-num")
    ...
    var renderMessage = () => {
      ...
      if (message) {
        ...
        return createVNode("div", {
          "class": bem16("error-message", errorMessageAlign)
        }, [slot ? slot({
          message
        }) : message]);
      }
    ...
    return () => {
      ...
      return createVNode(Cell, {
        ...
        "valueClass": bem16("value"),
        "titleClass": [bem16("label", [labelAlign, {
...
var [name17, bem17] = createNamespace("toast");
...
var [name18, bem18] = createNamespace("switch");
var switchProps = {
  size: numericProp,
  loading: Boolean,
  disabled: Boolean,
...
var [name19, bem19, t2] = createNamespace("address-edit-detail");
var AddressEditDetail_default = defineComponent({
  ...
  setup(props, _ref) {
    ...
    var renderSearchTitle = (express) => {
      if (express.name) {
        var text = express.name.replace(props.value, "<span class=" + bem19("keyword") + ">" + props.value + "</span>");
        return createVNode("div", {
          "innerHTML": text
        }, null);
      }
...
var [name20, bem20, t3] = createNamespace("address-edit");
var DEFAULT_DATA = {
  name: "",
  tel: "",
  city: "",
...
var AddressEdit_default = defineComponent({
  ...
  setup(props, _ref) {
    ...
    var getErrorMessage = (key) => {
      ...
      switch (key) {
        case "name":
          return value ? "" : t3("nameEmpty");
        case "tel":
          return props.telValidator(value) ? "" : t3("telInvalid");
        case "areaCode":
          return value ? "" : t3("areaEmpty");
        case "addressDetail":
          return value ? "" : t3("addressEmpty");
        case "postalCode":
          return value && !props.postalValidator(value) ? t3("postalEmpty") : "";
      }
    };
    var onSave = () => {
      var items = ["name", "tel"];
...
var [name21, bem21] = createNamespace("radio-group");
var radioGroupProps = {
  disabled: Boolean,
  iconSize: numericProp,
  direction: String,
...
var [name22, bem22] = createNamespace("tag");
var tagProps = {
  size: String,
  mark: Boolean,
  show: truthProp,
...
var [name23, bem23] = createNamespace("radio");
...
var [name24, bem24] = createNamespace("address-item");
...
var [name25, bem25, t4] = createNamespace("address-list");
...
var AddressList_default = defineComponent({
  ...
  setup(props, _ref) {
    ...
    var renderBottom = () => createVNode("div", {
      "class": [bem25("bottom"), "van-safe-area-bottom"]
    }, [createVNode(Button, {
      "round": true,
      "block": true,
      "type": "danger",
...
var [name26, bem26, t5] = createNamespace("calendar");
...
var [name27] = createNamespace("calendar-day");
  ...
  setup(props, _ref) {
    ...
    return () => {
      ...
      return createVNode("div", {
        "role": "gridcell",
        "style": style.value,
        "class": [bem26("day", type), className],
...
var [name28] = createNamespace("calendar-month");
...
var [name29] = createNamespace("calendar-header");
...
var [name30, bem27] = createNamespace("image");
var imageProps = {
  src: String,
  alt: String,
  fit: String,
  ...
  setup(props, _ref) {
    ...
    var renderPlaceholder = () => {
      if (loading.value && props.showLoading) {
        return createVNode("div", {
          "class": bem27("loading")
        }, [renderIcon(props.loadingIcon, bem27("loading-icon"), slots.loading)]);
      }
      if (error.value && props.showError) {
        return createVNode("div", {
          "class": bem27("error")
        }, [renderIcon(props.errorIcon, bem27("error-icon"), slots.error)]);
      }
    };
    var renderImage = () => {
...
var [name31, bem28] = createNamespace("card");
var cardProps = {
  tag: String,
  num: numericProp,
  desc: String,
...
var Card_default = defineComponent({
  ...
  setup(props, _ref) {
    ...
    var renderTitle = () => {
      ...
      if (props.title) {
        return createVNode("div", {
          "class": [bem28("title"), "van-multi-ellipsis--l2"]
        }, [props.title]);
      }
    };
    var renderThumbTag = () => {
    ...
    var renderPriceText = () => {
      ...
      return createVNode("div", null, [createVNode("span", {
        "class": bem28("price-currency")
      }, [props.currency]), createVNode("span", {
        "class": bem28("price-integer")
      }, [priceArr[0]]), createTextVNode("."), createVNode("span", {
        "class": bem28("price-decimal")
      }, [priceArr[1]])]);
    };
    return () => {
      var _slots$priceTop;
...
var [name32, bem29] = createNamespace("sticky");
var stickyProps = {
  zIndex: numericProp,
...
var [name33, bem30] = createNamespace("tab");
...
var [name34, bem31] = createNamespace("swipe");
var swipeProps = {
  loop: truthProp,
  width: numericProp,
  height: numericProp,
...
var [name35, bem32] = createNamespace("tabs");
...
var [name37, bem34] = createNamespace("swipe-item");
...
var [name38, bem35] = createNamespace("tab");
...
var [name39, bem36, t6] = createNamespace("cascader");
var cascaderProps = {
  title: String,
...
var Cascader_default = defineComponent({
  ...
  setup(props, _ref) {
    ...
    var renderHeader = () => createVNode("div", {
      ...
      "name": props.closeIcon,
      "class": [bem36("close-icon"), HAPTICS_FEEDBACK],
      "onClick": onClose
    }, null) : null]);
...
var [name40, bem37] = createNamespace("cell-group");
var cellGroupProps = {
  title: String,
  inset: Boolean,
  border: truthProp
...
var [name41, bem38] = createNamespace("checkbox-group");
...
var CHECKBOX_GROUP_KEY = Symbol(name41);
var CheckboxGroup_default = defineComponent({
  ...
  setup(props, _ref) {
    ...
    return () => createVNode("div", {
      "class": bem38([props.direction])
    }, [slots.default == null ? void 0 : slots.default()]);
  }
});

// node_modules/vant/es/checkbox/Checkbox.js
var [name42, bem39] = createNamespace("checkbox");
...
var [name43, bem40] = createNamespace("circle");
var uid = 0;
...
var [name44, bem41] = createNamespace("row");
var ROW_KEY = Symbol(name44);
var rowProps = {
  tag: makeStringProp("div"),
  wrap: truthProp,
  align: String,
...
var [name45, bem42] = createNamespace("col");
var colProps = {
  tag: makeStringProp("div"),
...
var [name46, bem43] = createNamespace("collapse");
var COLLAPSE_KEY = Symbol(name46);
var collapseProps = {
  border: truthProp,
  accordion: Boolean,
  modelValue: {
...
var [name47, bem44] = createNamespace("collapse-item");
...
var [name48, bem45, t7] = createNamespace("contact-card");
...
var ContactCard_default = defineComponent({
  ...
  setup(props, _ref) {
    ...
    return () => createVNode(Cell, {
      ...
      "class": bem45([props.type]),
      "border": false,
      "isLink": props.editable,
      "valueClass": bem45("value"),
      "onClick": onClick
    }, {
      value: renderContent
    });
...
var [name49, bem46] = createNamespace("form");
var formProps = {
  colon: Boolean,
  disabled: Boolean,
  readonly: Boolean,
...
// node_modules/@vant/lazyload/dist/esm/index.js
...
var LazyComponent = (lazy) => ({
  ...
  methods: {
    ...
    checkInView() {
      this.getRect();
      return inBrowser2 && this.rect.top < window.innerHeight * lazy.options.preLoad && this.rect.bottom > 0 && this.rect.left < window.innerWidth * lazy.options.preLoad && this.rect.right > 0;
    },
    load() {
      this.show = true;
      this.state.loaded = true;
...
var LazyImage = (lazyManager) => ({
  ...
  methods: {
    ...
    checkInView() {
      this.getRect();
      return inBrowser2 && this.rect.top < window.innerHeight * lazyManager.options.preLoad && this.rect.bottom > 0 && this.rect.left < window.innerWidth * lazyManager.options.preLoad && this.rect.right > 0;
    },
    load(onFinish = noop2) {
...
var Pagination_default = defineComponent({
  ...
  setup(props, _ref) {
    ...
    return () => {
      ...
      return createVNode("ul", {
      ...
      }, [slots["prev-text"] ? slots["prev-text"]() : props.prevText || t15("prev")]), pages.value.map((page) => createVNode("li", {
        "class": [bem71("item", {
          active: page.active
        }), bem71("page"), BORDER],
        ...
        "onClick": onSelect(value + 1)
      }, [slots["next-text"] ? slots["next-text"]() : props.nextText || t15("next")])]);
    };
  }
});
...
var Slider_default = defineComponent({
  ...
  setup(props, _ref) {
    ...
    var onTouchStart = (event) => {
      ...
      if (isRange(current)) {
        startValue = current.map(format3);
      } else {
        startValue = format3(current);
      }
    ...
    var renderButton = (index) => {
      var current2 = typeof index === "number" ? props.modelValue[index] : props.modelValue;
      return createVNode("div", {
        "role": "slider",
...
var Stepper_default = defineComponent({
  ...
  setup(props, _ref) {
    ...
    var check = () => {
      var value = format3(current.value);
    ...
    var onChange = () => {
      ...
      var value = format3(addNumber(+current.value, diff));
      setValue(value);
      emit(actionType);
    };
    var onInput = (event) => {
...
var [name95, bem91] = createNamespace("uploader");
